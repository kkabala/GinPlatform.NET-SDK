...
Apart from that you have "GinPlatformSettings" class when you can:
  - Store your apiKey to be reused by all clients (in case you don't want to pass the same apiKey to a client's method every single time)
